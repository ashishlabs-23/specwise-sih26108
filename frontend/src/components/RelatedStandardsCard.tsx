          ...
          {related_standards.length === 0 ? (
            ...
            related_standards.slice(0, 2).map((rel, idx) => (
              <div
                ...
                className="group p-3 rounded-xl border border-slate-200 hover:border-blue-400 bg-slate-50/50 hover:bg-blue-50/30 transition-all cursor-pointer"
              >
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <div>
                      <div className="flex items-center gap-1.5">
                        ...
                        {rel.hop && (
                          <span className="text-[10px] px-1 py-0.2 rounded bg-slate-200/70 text-slate-600 font-semibold">
                            Hop {rel.hop}
                          </span>
                        )}
                      </div>
                      ...
                      <div className="mt-2">
                        <span className="inline-flex items-center px-2 py-0.5 rounded text-[11px] font-medium bg-blue-100/70 text-[#0A3871]">

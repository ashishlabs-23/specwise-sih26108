...
export function AllSourcesModal({ isOpen, onClose, evidence }: AllSourcesModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[85vh] flex flex-col shadow-2xl border border-slate-200 relative animate-in fade-in zoom-in-95 duration-150">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold text-slate-900">
                All Verified Sources & Evidence Records
              </h3>
              <p className="text-xs text-slate-500 font-medium">
                Official BIS publications, guidelines, and committee work documents
              </p>
            </div>
          </div>
        ...
        {/* Content list */}
        <div className="flex-1 p-6 overflow-y-auto space-y-4 divide-y divide-slate-100">
          {evidence.map((ev, idx) => (
            <div key={idx} className="pt-4 first:pt-0">
              ...
              <div className="mt-2 flex items-center justify-between text-xs">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1 text-[#0B57D0] hover:underline font-mono text-[11px]"
                >
